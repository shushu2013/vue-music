          ...
          <div class="progress-wrapper">
            ...
            <div class="progress-bar-wrapper">
              <ProgressBar :percent="percent"
                           @precentChange="onProgressBarChange"></ProgressBar>
            </div>
...
export default {
  ...
  methods: {
    ...
    _getPosAndScale() {
      ...
      const y = window.innerHeight - paddingTop - width / 2 - targetWidth / 2 - paddingBottom
      return {
        x,
        y,
        scale
